...
module.exports.loader = (_0x4705f2, _0x10a189) => {
  switch (_0x10a189) {
    case "warn":
      console.log(chalk.bold.hex(randomColor()).bold(" AKASH ERROR•—»✨ ") + chalk.bold.hex("#8B8878").bold(_0x4705f2) + chalk.bold.hex("FF00DD")(''));
      break;
    case "error":
      console.log(chalk.bold.hex(randomColor()).bold(" AKASH ERROR•—»✨ ") + _0x4705f2 + chalk.bold.hex("5EFF00")(''));
      break;
    default:
      console.log(chalk.bold.hex(randomColor()).bold("AKASH•—»✨ ") + chalk.bold.hex(randomColor()).bold(_0x4705f2) + chalk.bold.hex("FFF0000")(''));
      break;
  }
};
