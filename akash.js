...
console.log(chalk.bold.hex("#00ffff").bold("[MAX ROBOT]") + chalk.bold.hex("#00ffff").bold("Initializing variables..."));
...
try {
    ...
    logger.loader("Found file config: akash.json");
}
catch {
    ...
    else return logger.loader("akash.json not found!", "error");
}
...
try {
    var appStateFile = resolve(join(global.client.mainPath, global.config.APPSTATEPATH || "akashstate.json"));
